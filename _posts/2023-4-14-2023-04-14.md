...
![To those accustomed to privilege, equality feels like oppression. ~ Anonymous](../../../assets/img/self-documenting/equality-oppression.jpg)
...
This is definitely an *oof* revelation coming out of Samsung's semiconductor group. Engineers were given the go-ahead to use ChatGPTfor solving problems. Unfortunately, the parameters of what could go into ChatGPT may not have been clear and source code, meeting notes, among other data were put in and are now forever a part of ChatGPT's data, with no definite recourse to have the data removed.
